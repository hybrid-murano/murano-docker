...
class RefreshThisEnvironment(tables.Action):
    ...
    def single(self, data_table, request, service_id):
        environment_id = data_table.kwargs['environment_id']
        return shortcuts.redirect(reverse('horizon:murano:environments:services', args=(environment_id,)))
...
class ServicesTable(tables.DataTable):
    ...
    class Meta(object):
        ...
        table_actions = (RefreshThisEnvironment, AddApplication, DeployThisEnvironment)
