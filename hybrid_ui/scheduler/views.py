...
class Wizard(views.ModalFormMixin, LazyWizard):
    template_name = 'scheduler/wizard_create.html'
    do_redirect = False
...
class SchedulerView(tabs.TabbedTableView):
    ...
    def get_redirect_url():
        return reverse_lazy("horizon:murano:scheduler:index")
...
class DeploymentDetailsView(tabs.TabbedTableView):
    ...
    template_name = 'scheduler/reports.html'
    ...
    def get_deployment(self):
        ...
        try:
            ...
            redirect = reverse("horizon:murano:scheduler:deployments")
            exceptions.handle(self.request,
