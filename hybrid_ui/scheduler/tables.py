...
#            api.environment_deploy(request, get_scheduler_id())
        return shortcuts.redirect(reverse('horizon:murano:scheduler:index'))
...
class ServicesTable(tables.DataTable):
    ...
    name = tables.Column('name', verbose_name=_('Name'), link="horizon:murano:scheduler:service_details")
    ...
    def get_row_actions(self, datum):
        ...
        for action_datum in api.extract_actions_list(datum):
            ...
            class CustomAction(tables.LinkAction):
                ...
                url = reverse('horizon:murano:scheduler:start_action', args=(action_datum['id'],))
                classes = _classes
                table = self
...
class ShowDeploymentDetails(tables.LinkAction):
    ...
    def get_link_url(self, deployment):
        return reverse('horizon:murano:scheduler:deployment_details', args=(deployment.id,))
