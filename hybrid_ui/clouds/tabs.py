...
class OverviewTab(tabs.Tab):
    ...
    no_show = set(['name', '?', 'date', 'time', 'mode', 'environment_version', 'environment_id', 'operation_updated', 'operation'])
...
class ServiceLogsTab(tabs.Tab):
    ...
    def get_context_data(self, request):
        ...
        environment_id = tables.get_cloud_id()
...
class EnvironmentServicesTab(tabs.TableTab):
    ...
    def get_services_data(self):
        services = []
        self.environment_id = tables.get_cloud_id()
...
class EnvironmentDetailsTabs(tabs.TabGroup):
    ...
    tabs = (EnvironmentServicesTab, EnvironmentTopologyTab, DeploymentTab, LatestLogsTab)
