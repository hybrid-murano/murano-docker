...
class ServicesTable(tables.DataTable):
    name = tables.Column('name', verbose_name=_('Name'), link="horizon:admin:clouds:service_details")
    ...
    def get_row_actions(self, datum):
        ...
        for action_datum in api.extract_actions_list(datum):
            ...
            class CustomAction(tables.LinkAction):
                ...
                url = reverse('horizon:admin:clouds:start_action', args=(action_datum['id'],))
                classes = _classes
                table = self
    ...
    class Meta(object):
        ...
        table_actions = (RefreshThisEnvironment,DeployThisEnvironment,)
...
class ShowDeploymentDetails(tables.LinkAction):
    ...
    def get_link_url(self, deployment):
        return reverse('horizon:admin:clouds:deployment_details', args=(deployment.id,))
