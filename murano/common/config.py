...
murano_opts = [
    ...
    cfg.IntOpt('period', default=5,
               help=_('Scheduler interval in seconds. Default value is 5 seconds.'))
]
...
engine_opts = [
    ...
    cfg.BoolOpt('use_deploy', default=True,
                help=_('Enable use default deploy method other than _config/_kickoff/_reconfig/_final')),
