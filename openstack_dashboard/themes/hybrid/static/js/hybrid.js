...
horizon.datatables.redraw_az = function () {
  var AWS = $("<div>").addClass("loading_gif").append($("<img>").attr("src", STATIC_URL + "themes/hybrid/img/aws-icon.png").attr("height", "50").attr("width", "50")).html();
  var VCLOUD = $("<div>").addClass("loading_gif").append($("<img>").attr("src", STATIC_URL + "themes/hybrid/img/vcloud-icon.png").attr("height", "50").attr("width", "50")).html();
  var FS = $("<div>").addClass("loading_gif").append($("<img>").attr("src", STATIC_URL + "themes/hybrid/img/fs-icon.png").attr("height", "50").attr("width", "50")).html();
  var HWS = $("<div>").addClass("loading_gif").append($("<img>").attr("src", STATIC_URL + "themes/hybrid/img/hws-icon.png").attr("height", "50").attr("width", "50")).html();
  var OPENSTACK = $("<div>").addClass("loading_gif").append($("<img>").attr("src", STATIC_URL + "themes/hybrid/img/openstack.png").attr("height", "50").attr("width", "50")).html();
  var OTC = $("<div>").addClass("loading_gif").append($("<img>").attr("src", STATIC_URL + "themes/hybrid/img/otc.png").attr("height", "50").attr("width", "50")).html();
  function _redraw_az() {
